...
//double DomCompare(int newType, int domType) ;       //match.c
//int GetBeatTypeCount(int type) ;                    //match.c
...
void MATCHcls::ResetPostClassify()
	{
	int i, j ;
...
void MATCHcls::PostClassify(int *recentTypes, int domType, int *recentRRs, int width, double mi2,
	int rhythmClass)
	{
...
int MATCHcls::CheckPostClass(int type)
	{
	int i, pvcs4 = 0, pvcs8 ;
...
int MATCHcls::CheckPCRhythm(int type)
	{
	int i, normCount, n ;
